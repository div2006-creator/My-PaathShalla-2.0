    ...
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 min-h-screen relative z-10 overflow-hidden bg-slate-950 text-white">
      ...
      <div className="w-full max-w-md flex flex-col items-center z-10 space-y-6">
        ...
        <div className="w-full flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-xs text-slate-400 font-bold">Commercial EdTech Digital Classroom & LMS</p>
        </div>
        ...
        {/* Login/Register Card */}
        <div className="w-full bg-slate-900 rounded-2xl p-6 sm:p-8 shadow-2xl border border-slate-800 space-y-5">
          ...
          <div className="space-y-2">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white hover:bg-slate-100 text-slate-900 rounded-xl transition-all font-extrabold text-xs shadow-md active:scale-[0.98]"
            >
              ...
              <span>Continue with Google ({role === 'TEACHER' ? 'Teacher' : 'Student'})</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2 pt-2">
              <button 
                type="submit" 
                disabled={submitting}
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-xs py-3.5 rounded-xl shadow-md flex items-center justify-center gap-2 active:scale-95 transition-all disabled:opacity-50"
              >
